...
import GoIcon from "../images/icons/Go_Icon"
...
function IndexPage() {
  ...
  return (
    <Layout>
      ...
      <section className="nine about">
        ...
        <div className="focus-wrapper">
          <div className="grid rows bullet-point-wrapper">
            ...
            <div className="grid card focus-area">
              <h4>Performant</h4>
      ...
      <section className="nine skills">
        <div className="flex rows sub-heading">
          <h2>I Have Experience With...</h2>
        </div>

        <div id="devicons" className="six center">
          <div className="card">
      ...
      <section className="nine contact">
        <div className="flex rows sub-heading">
